(function() {
    ...
    function WeatherService($http) {
        ...
        service.init = function(geoposition) {
            geoloc = geoposition;
            return $http.jsonp('https://api.forecast.io/forecast/'+FORCAST_API_KEY+'/'+geoposition.coords.latitude+','+geoposition.coords.longitude+'?callback=JSON_CALLBACK&units=ca').
        ...
        service.currentForcast = function() {
            ...
            console.log(service.forcast.data.currently)
        }
